  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12 col-md-12">
        <h2 class="sixip-latest-events"> Sponsors
    ...
    <div class="row">
      <div class="col-md-12">
        <!-- <div class="latest-btn-holder"><a href="event.php" class="sixip-btn-gold">View All On Demand <i class="fas fa-arrow-right"></i></a></div> -->
      </div>
    </div>
  </div>
  <!--container-->
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="
													<?= base_url("event-join-mail"); ?>" method="post">
